...
if __name__ == "__main__":
    ...
    _, _, test_loader = make_dataloaders(data, window_size=config.window_size, batch_size=config.batch_size)

    current_dir = os.path.dirname(os.path.abspath(__file__))
    checkpoint_path = os.path.join(current_dir, '../checkpoints_lightning/tft-epoch=21-val_loss=0.601956.ckpt')
