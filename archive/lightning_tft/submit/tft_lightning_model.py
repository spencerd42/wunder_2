...
class TemporalFusionTransformerLightning(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # ReduceLROnPlateau: monitors val_loss and reduces LR when it stops improving
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
            optimizer,
            mode='min',              # minimize val_loss
            factor=self.lr_scheduler_factor,  # multiply LR by 0.5
            patience=self.lr_scheduler_patience,  # wait 8 epochs before reducing
        ...
        return {
            ...
            'lr_scheduler': {
                ...
                'interval': 'epoch',
                'frequency': 1,
                'strict': False          # allow training to continue even if metric not found
            }
        }
